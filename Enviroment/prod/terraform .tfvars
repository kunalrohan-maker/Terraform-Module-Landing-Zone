...
pip = {
  pip1 = { name = "BastionIP", res = "Prod_Rohan", loc = "Japaneast", allo = "Static" }
  pip2 = {name = "NAT_IP", res = "Prod_Rohan", loc = "Japaneast", allo = "Static"} 
  pip3 = { name = "frontendIP", res = "Prod_Rohan", loc = "Japaneast", allo = "Static"}
}

bastion = {

  bastion1 = { name = "Azure_Bastion", res = "Prod_Rohan", loc = "Japaneast", ip = "Bastion_IP", subnet_id = "S4", public_ip_address_id = "pip1" }
}

NAT = {
  NAT1 = {name = "NAT", loc = "Japaneast", res = "Prod_Rohan", public_ip_address_id = "pip2", sku = "Standard"}
}
...
NIC = {
  NIC1 ={name = "NIC_Frontend",loc = "Japaneast",res = "Prod_Rohan",IP_name = "frontend_IP", allocation = "Dynamic",subnet_id = "S1",NSG_id = "NSG1"}
  NIC2 ={name = "NIC_Backend",loc = "Japaneast",res = "Prod_Rohan",IP_name = "backend_IP", allocation = "Dynamic",subnet_id = "S2", NSG_id = "NSG2"}
 }

 VM = {
  VM1 = {name = "frontendVM",res = "Prod_Rohan",loc = "Japaneast",size = "Standard_D2s_v3",admin_username = "test123456", admin_password = "Test_123456789",
  ...
  VM2 = {name = "backendVM",res = "Prod_Rohan",loc = "Japaneast",size = "Standard_D2s_v3",admin_username = "test123456", admin_password = "Test_123456789",
  disable_password_authentication = false, caching = "ReadWrite", storage_account_type = "Standard_LRS", publisher = "Canonical", offer = "UbuntuServer",
 ...
 lb = {
  lb1 = { name = "LoadBalancer",loc = "Japaneast", res= "Prod_Rohan", frontendIP_config = "Frontend_IP", public_ip_address_id = "pip3"}
 }
